!function($, wysi) {
    ...
    var tpl = {
        ...
        "format-code": function(locale, options) {
              ...
              return "<li>" +
                "<div class='btn-group'>" +
                  "<a class='btn btn-" + size + " btn-default' data-wysihtml5-action='formatCode' title='" + locale.formatCode.highlight + "' tabindex='-1'><i class='glyphicon glyphicon-list-alt'></i></a>" +
                "</div>" +
              "</li>";
         },
